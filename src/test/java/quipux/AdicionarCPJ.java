...
@CucumberOptions (//features = "src/test/resources/feature/SOI/PA/CONSULTA_COTIZANTES", tags = {"@Escenario_33"}, monochrome= true, snippets= SnippetType.CAMELCASE)
		 ...
		 features = "src/test/resources/features/Qits/Forms/AdicionarExpediente.feature", tags = {"@CrearPersonaJurídica"}, snippets= SnippetType.CAMELCASE)
@RunWith(RunnerPersonalizado.class)
public class AdicionarCPJ {
	@BeforeSuite
	public static void test() throws InvalidFormatException, IOException {
			DataToFeature.overrideFeatureFiles("src/test/resources/features/Qits/Forms/AdicionarExpediente.feature");
	}
}
